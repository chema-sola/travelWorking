            ...
            <form id='stripe-login'>
              ...
              <div className='field padding-bottom--24 box_fecha_nacimiento'>
                <div>
                  ...
                  >
                    <option disabled hidden value={'mes'}>
                      Mes
                    </option>
                ...
                <select id='dobDay' defaultValue={'dia'} name='dobDay' data-dob='' className='form-control input-lg'>
                  <option disabled hidden value={'dia'}>
                    Dia
                  </option>
                ...
                <select id='dobYear' defaultValue={'año'} name='dobYear' data-dob='' className='form-control input-lg'>
                  <option disabled value={'año'} hidden>
                    Año
                  </option>
              ...
              <div className='field padding-bottom--24'>
                ...
                <div>
                  <select
                    ...
                    className='form-control input-lg'
                  >
                    <option disabled='' value={'residencia'} hidden>
                      Lugar de residencia
                    </option>
