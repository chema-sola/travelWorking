      ...
      <footer className='footer-distributed'>
        ...
        <div className='footer-right'>
          <p className='footer-company-about'>
            ...
            Somos un grupo de personas con ganas de ayudar a los que desean cumplir su sueño de viajar, pero no
            disponen de los recursos necesarios para ello. Creemos en un mundo justo donde debe haber oportunidades para todas las personas.{' '}
          </p>
